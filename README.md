...
<div
  class="clothe__card"
  style="width: 150px;padding: 10px; height: 200px;background-color: aliceblue; color: antiquewhite;border-radius: 8px; display: flex;flex-direction: column; gap: 10px;justify-content: space-between;"
>
